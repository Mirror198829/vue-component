...
@border-color:#52616b;
.draggableWrap{background-color: #fff;height:100%;display: flex;flex-direction: column;box-sizing: border-box;padding:20px;}
#drag-main{border:1px solid @border-color;margin-top:20px;padding:15px;flex:1;}
.flip-list-move {
...
.list1-group-item {list-style: none;border:1px solid @border-color;cursor: move;border-radius: 3px;float: left;width:100px;height:100px;margin:5px;}

.list1-group-item i{
  cursor: pointer;
}
.list2-group-item{list-style: none;border:1px solid @border-color;width:250px;height:250px;margin:10px;background-color: #fff;float: left}
</style>
